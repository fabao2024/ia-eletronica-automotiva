...
- Documentation lives in `README.md`, `INSTRUCTIONS.md`, and `AGENTS.md`.
...
- Keep docs, comments, and contributor-facing text in English.
...
- Existing history uses prefixes like `docs:` and `feat:`; continue with Conventional Commits (`feat:`, `fix:`, `docs:`, `chore:`).
...
- For camera/microphone features, require explicit opt-in (toggle/button) before rendering permission widgets such as `st.camera_input`.
